...
class HorizontalWaterDropHeader extends RefreshIndicator {
  /// refreshing content
  ...
  const HorizontalWaterDropHeader({
    Key? key,
    this.refresh,
    this.complete,
  ...
  State<StatefulWidget> createState() {
    ...
    return _HorizontalWaterDropHeaderState();
  }
}

class _HorizontalWaterDropHeaderState extends RefreshIndicatorState<HorizontalWaterDropHeader>
  ...
  //   return Transform.rotate(angle: 90, child: getContent(context, mode));
  // }

  // Widget getContent(BuildContext context, RefreshStatus? mode) {
    ...
    if (mode == RefreshStatus.refreshing) {
      ...
      return FadeTransition(
          opacity: _dismissCtl,
          // rotate 90 degrees (radians)
          child: Transform.rotate(angle: pi * 1.5,
            // origin: Offset(30, 0),
