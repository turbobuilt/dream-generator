...
///    of children.
abstract class SliverChildDelegate_old {
  /// Abstract const constructor. This constructor enables subclasses to provide
  /// const constructors so that they can be used in const expressions.
  const SliverChildDelegate_old();
...
class SliverChildListDelegate extends SliverChildDelegate {
  ...
  ///
  /// ```dart
  /// class SomeWidgetState extends BetterState<SomeWidget> {
...
class _SelectionKeepAliveState extends BetterState<_SelectionKeepAlive> with AutomaticKeepAliveClientMixin implements SelectionRegistrar {
