...
let modalEndpoint = "https://noise-destroyer--dreamshaper-v8-f.modal.run";

export async function generateDreamshaperV8Modal(prompt: string, imgGenRequest: ImageGenerationRequest): Promise<any> {
    try {
